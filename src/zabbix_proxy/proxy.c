...
zbx_vector_ptr_t *API_CALLBACKS;
...
char *CONFIG_SHELLSCRIPTS_DIR = NULL;
int CONFIG_SHELLSCRIPT_MAXSIZE = 0;
...
int	CONFIG_FORKS[ZBX_PROCESS_TYPE_COUNT] = {
	...
	0, /* ZBX_PROCESS_TYPE_SNMPTRAPPER - deprecated */
...
static void	zbx_load_config(ZBX_TASK_EX *task)
{
	struct cfg_line	cfg[] =
	{
		/* PARAMETER,			VAR,					TYPE,
			MANDATORY,	MIN,			MAX */
		{"ShellScriptsDir", &CONFIG_SHELLSCRIPTS_DIR, TYPE_STRING,
			PARM_OPT, 0, 0},
		{"ShellScriptMaxSize", &CONFIG_SHELLSCRIPT_MAXSIZE,  TYPE_INT,
			 PARM_OPT, 0, 65536},
