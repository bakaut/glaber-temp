...
$host_is_discovered = ($data['host']['flags'] == ZBX_FLAG_DISCOVERY_CREATED || false == $data['host']['can_edit'] );
...
$templates_field_items[] = (new CMultiSelect([
	...
	'disabled' => false == $data['host']['can_edit'],
	...
	->addItem([
		...
		new CFormField(
			(new CCheckBox('status', HOST_STATUS_MONITORED))
				...
				->setReadonly(false == $data['host']['can_edit'])
		)
	]);
...
$tags_tab = new CPartial('configuration.tags.tab', [
	...
	'tags' => $data['host']['tags'],
	'with_automatic' => true,
	'readonly' => false == $data['host']['can_edit'],
	'tabs_id' => 'host-tabs',
