...
class CXmlConstantValue {
	...
	const ITEM_TYPE_TRAP_REGEXP = ITEM_TYPE_TRAP_REGEXP;
	const ITEM_TYPE_SNMP_TRAP = ITEM_TYPE_TRAP_REGEXP;
	...
	const DISPATCH_LOCAL_REGEXP = GLB_PREPROC_LOCAL_DISPATCH_REGEXP;
