...
class CItem extends CItemGeneral {
	...
	public const SUPPORTED_PREPROCESSING_TYPES = [
		...
		GLB_PREPROC_JSON_FILTER, GLB_PREPROC_DISCOVERY_PREPARE, GLB_PREPROC_LOCAL_DISPATCH,  GLB_PREPROC_LOCAL_DISPATCH_REGEXP
	];
	...
	public const SUPPORTED_ITEM_TYPES = [
		...
		ITEM_TYPE_JMX, ITEM_TYPE_TRAP_REGEXP, ITEM_TYPE_DEPENDENT, ITEM_TYPE_HTTPAGENT, ITEM_TYPE_SNMP, ITEM_TYPE_SCRIPT,
