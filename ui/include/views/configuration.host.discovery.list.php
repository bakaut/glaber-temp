...
unset($lld_types[ITEM_TYPE_HTTPTEST], $lld_types[ITEM_TYPE_CALCULATED], $lld_types[ITEM_TYPE_TRAP_REGEXP]);
...
foreach ($data['discoveries'] as $discovery) {
	...
	if ($discovery['type'] == ITEM_TYPE_TRAPPER || $discovery['type'] == ITEM_TYPE_TRAP_REGEXP
